...
import FeedingPhotoSourceSheet from "./FeedingPhotoSourceSheet.js";

const MAX_PHOTOS = 5;

const FeedingDetailsSheet = forwardRef(function FeedingDetailsSheet(
  { onSave },
  forwardedRef,
) {
        ...
        >
          <View style={styles.header}>
            <View style={styles.headerText}>
              <Text style={styles.title}>{t("Add details")}</Text>

              <Text style={styles.description}>
                {t("Add an optional note or photos about this feeding")}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.noteSection}>
            ...
            <BottomSheetTextInput
              ...
              placeholder={t("For example, ate well or discovered a new food")}
...
export default FeedingDetailsSheet;
